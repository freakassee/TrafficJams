...
public class DeutschlandFunk {
	public static void main(String[] args) {
		DeutschlandFunk dlf = new DeutschlandFunk();
		dlf.run(true);
	}

	public DeutschlandFunk() {
	...
	public void run(boolean isOnline) {
		try {
			...
			if (!isOnline) {
				...
				URL dlf_urlLOCALHOST = new
				 URL("http://localhost:8081/examples/dlf.htm");
				// URL("http://localhost:8081/examples/dlf2.htm");
				// URL("http://localhost:8081/examples/dlf3.htm");
				// URL("http://localhost:8081/examples/dlf4.htm");
				// URL("http://localhost:8081/examples/dlf_empty.htm");
